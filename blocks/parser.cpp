...
{
       0,   102,   102,   108,   109,   121,   122,   126,   127,   128,
     132,   133,   137,   138,   139,   140,   141,   142,   143,   144,
     148,   149,   153,   154,   155,   159,   160,   164,   165,   169,
     170,   171,   172,   176,   180,   181,   185,   186,   187,   188,
...
#line 193 "parser.y"
                   {(yyval.stmts)=new Stmt_expr((yyvsp[-1].exprs));}
...
#line 1605 "parser.cpp"
  ...
  case 61: /* expr: '(' expr ')'  */
#line 228 "parser.y"
               {(yyval.exprs)= new Exprpar((yyvsp[-1].exprs));}
...
#line 1659 "parser.cpp"
  ...
  case 70: /* cond: '(' cond ')'  */
#line 240 "parser.y"
              {(yyval.conds)= new Cond_st1{(yyvsp[-1].conds)};}
#line 1665 "parser.cpp"
    break;

  case 71: /* cond: "not" cond  */
#line 241 "parser.y"
             {(yyval.conds)= new Cond_st2{(yyvsp[0].conds)};}
